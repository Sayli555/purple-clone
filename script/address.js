...
var ans=localStorage.getItem("num")
console.log(ans);

document.getElementById("TotalPR").innerText=`Rs ${ans}`;

document.getElementById("TPR").innerText=`Rs ${ans}`;
...
function gotopayment(){
    ...
    var data=JSON.parse(localStorage.getItem("addressDetails"))||[];
    var obj={
        name,
        Pincode, 
        address,
    ...
    alert("Your Adress is succesfully save");

   window.location.href="payment.html"
}

// https://hardcore-rosalind-4154f4.netlify.app/
